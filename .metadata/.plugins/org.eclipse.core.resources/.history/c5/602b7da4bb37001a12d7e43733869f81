...
public class CompanyController {
	...
	public CompanyDTO actualizarCompany(@PathVariable("id_company") Long id_company, @RequestBody CompanyReducidoDTO companyReducidoDTO) throws ResourceNotFoundExecption {

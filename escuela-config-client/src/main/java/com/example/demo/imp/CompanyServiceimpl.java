...
public class CompanyServiceimpl implements CompanyService {
	...
	public Company actualizarCompany(Long id_company, CompanyReducidoDTO companyReducidoDTO) throws ResourceNotFoundExecption {
		// TODO Auto-generated method stub
		Company company = companyRepository.findById(id_company).orElseThrow(
				() -> new ResourceNotFoundExecption("No se encontro la compañia con el codigo: " + id_company));
		company.setNombre(companyReducidoDTO.getNombre());
		company.setRazonSocial(companyReducidoDTO.getRazonSocial());
		company.setRUC(companyReducidoDTO.getRUC());
		return companyRepository.save(company);
	}
